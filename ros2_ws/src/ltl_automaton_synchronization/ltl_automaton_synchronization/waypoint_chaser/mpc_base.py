...
if __name__ == '__main__':
    ...
    opts_setting = {'ipopt.max_iter':100, 'ipopt.print_level':0, 'print_time':0, 'ipopt.acceptable_tol':1e-8, 'ipopt.acceptable_obj_change_tol':1e-6, 'ipopt.sb':"yes"}
    ...
    draw_result = Draw_MPC_Obstacle(rob_diam=0.3, init_state=x0_, target_state=xs, robot_states=xx, obstacle=np.array([obs_x, obs_y, obs_diam/2., obs_x2, obs_y2, obs_diam/2., obs_x3, obs_y3, obs_diam/2.]), export_fig=True)
