...
def mission_to_buchi(ros_node, hard_spec, soft_spec):
    ...
    ros_node.get_logger().info('LTL Planner: full Buchi constructed with %d states and %s transitions' %(len(buchi.nodes()), len(buchi.edges())))
    return buchi
