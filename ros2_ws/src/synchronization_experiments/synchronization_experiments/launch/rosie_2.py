...
def generate_launch_description():
    agents = ['/rosie0', '/rosie2']#['/rosie0','/rosie1', '/rosie2','/turtlebot1', '/turtlebot2']
    dynamic_obstacles = ['/rosie2', '/turtlebot1']#['/rosie0','/rosie1', '/turtlebot1', '/turtlebot2']
    action_node= Node(
            ...
            output='screen',
            parameters=[
                {'motion_action_dictionary_path': os.path.join(get_package_share_directory('synchronization_experiments'), 'config', 'rosie2_lab.yaml')},
                {'agents': agents},
