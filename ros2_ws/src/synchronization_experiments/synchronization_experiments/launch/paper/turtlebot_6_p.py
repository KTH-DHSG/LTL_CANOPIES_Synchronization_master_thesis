...
def generate_launch_description():
    ...
    dynamic_obstacles = ['/rosie0', '/rosie1', '/rosie2', '/turtlebot1', '/turtlebot2', '/turtlebot3', '/turtlebot4', '/turtlebot5']#, '/turtlebot7']
    action_node= Node(
    ...
    planner_node= Node(
            ...
            parameters=[
                ...
                {'hard_task':'X wait && <> (remove_object && <>(patrol && p5 && <>(check_connection && c2))) && []<> (patrol && p5 && <> (patrol && p9))' },
                {'soft_task': ""},
