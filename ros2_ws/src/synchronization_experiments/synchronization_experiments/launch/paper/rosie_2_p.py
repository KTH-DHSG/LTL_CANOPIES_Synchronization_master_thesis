...
def generate_launch_description():
    ...
    dynamic_obstacles = ['/rosie0', '/rosie1', '/turtlebot1', '/turtlebot2', '/turtlebot3', '/turtlebot4', '/turtlebot5', '/turtlebot6', '/basket']#, '/turtlebot7']
    action_node= Node(
            ...
            output='screen',
            parameters=[
                {'motion_action_dictionary_path': os.path.join(get_package_share_directory('synchronization_experiments'), 'config/paper', 'rosie2.yaml')},
                {'agents': agents},
    ...
    planner_node= Node(
            ...
            output='screen',
            parameters=[
                {'hard_task':'X wait && []<> (harvest && h2 && <> (harvest && h4 && <> deliver))' },
                {'soft_task': ""},
