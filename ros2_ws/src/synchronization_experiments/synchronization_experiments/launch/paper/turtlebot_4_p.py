...
def generate_launch_description():
    ...
    dynamic_obstacles = ['/rosie0', '/rosie1', '/rosie2', '/turtlebot1', '/turtlebot2', '/turtlebot3', '/turtlebot5', '/turtlebot6']#, '/turtlebot7']
    action_node= Node(
    ...
    planner_node= Node(
            ...
            parameters=[
                ...
                {'hard_task':'X wait && []<> (patrol && p14 && <> (patrol && p11 && <> (check_connection && c1)))' },
                {'soft_task': ""},
