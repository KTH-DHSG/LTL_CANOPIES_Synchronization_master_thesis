...
def generate_launch_description():
    ...
    dynamic_obstacles = ['/rosie0','/rosie2', '/turtlebot1', '/turtlebot2']
    action_node= Node(
            ...
            output='screen',
            parameters=[
                {'motion_action_dictionary_path': os.path.join(get_package_share_directory('synchronization_experiments'), 'config', 'rosie1_nominal.yaml')},
                {'agents': agents},
    ...
    planner_node= Node(
            ...
            output='screen',
            parameters=[
                {'hard_task':'[]<> (manipulate && m3 && <> (manipulate && m4 ))' },
                {'soft_task': ""},
