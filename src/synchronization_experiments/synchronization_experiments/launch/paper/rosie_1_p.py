...
def generate_launch_description():
    ...
    dynamic_obstacles = ['/rosie0', '/rosie2', '/turtlebot1', '/turtlebot2', '/turtlebot3', '/turtlebot4', '/turtlebot5', '/turtlebot6', '/basket']#, '/turtlebot7']
    action_node= Node(
    ...
    planner_node= Node(
            ...
            output='screen',
            parameters=[
                {'hard_task':'X wait &&  []<> (supervise && <> (load && <> manipulate))' },
                {'soft_task': ""},
